...
struct ImageNames {
    ...
    static let hudHealthHeader = "hud-health-meter"
    static let hudHealthBar = "hud-health-bar"
    static let hudGoldHeader = "hud-gold-header"
    static let hudLevelHeader = "hud-level-header"
    static let hudUseItemButton = "hud-use-item-button"
    static let hudUseItemHeader = "hud-use-item-header"
    static let hudUseSpecialButton = "hud-use-special-button"
    static let hudUseSpecialHeader = "hud-use-special-header"
