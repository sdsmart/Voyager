...
class Hud: SKSpriteNode {
    ...
    struct Constants {
        ...
        static let levelHeaderVerticalOffset: CGFloat = 7.0
        static let levelValueHorizontalOffset: CGFloat = 58.0
        static let levelValueVerticalOffset: CGFloat = 7.0
        ...
        static let goldHeaderVerticalOffset: CGFloat = 7.0
        static let goldValueHorizontalOffset: CGFloat = 126.0
        static let goldValueVerticalOffset: CGFloat = 7.0
