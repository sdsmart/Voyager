...
class LevelScene: SKScene {
    ...
    private func initializePauseMenu() {
        ...
        resumeButton.addTarget(self, action: Selector("pauseButtonPressed"), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        saveAndQuitButton.addTarget(self, action: Selector("saveAndQuitButtonPressed"), forControlEvents: UIControlEvents.TouchUpInside)
